...
namespace XLua
{
    public partial class DelegateBridge_Wrap : DelegateBridge
    {
		...
		public double __Gen_Delegate_Imp11()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.Vector3 __Gen_Delegate_Imp12()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(LuaValue.CallJ))
			{
			    return new LuaValue.CallJ(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(NewBehaviourScript.CallJ))
			{
			    return new NewBehaviourScript.CallJ(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(LuaValue.CallV3))
			{
			    return new LuaValue.CallV3(__Gen_Delegate_Imp12);
			}
